    ...
    <nav class="flex-1 overflow-y-auto px-4 py-2 space-y-6 scrollbar-hide">
        ...
        <div>
            ...
            <ul class="space-y-1">
                ...
                <li>
                    <a href="master_gudang.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group <?= basename($_SERVER['PHP_SELF']) == 'master_gudang.php' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/20' : 'text-slate-400 hover:bg-white/5 hover:text-white' ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                        <span class="text-sm font-semibold">Data Gudang</span>
                    </a>
                </li>
                <li>
                    <a href="master_furniture.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group <?= basename($_SERVER['PHP_SELF']) == 'master_furniture.php' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/20' : 'text-slate-400 hover:bg-white/5 hover:text-white' ?>">
                        ...
                        <span class="text-sm font-semibold">Data Barang</span>
                    </a>
                </li>
                <li>
                    <a href="master_supplier.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group <?= basename($_SERVER['PHP_SELF']) == 'master_supplier.php' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/20' : 'text-slate-400 hover:bg-white/5 hover:text-white' ?>">
                        ...
                        <span class="text-sm font-semibold">Data Supplier</span>
                    </a>
                </li>
                <li>
        ...
        <!-- Group 2: TRANSAKSI -->
        <div>
            <p class="px-4 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mb-4">Transaksi Bisnis</p>
            <ul class="space-y-1">
                <?php if (check_access(['Admin', 'Supervisor'])): ?>
                <li>
                    <a href="transaksi_po.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group <?= basename($_SERVER['PHP_SELF']) == 'transaksi_po.php' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/20' : 'text-slate-400 hover:bg-white/5 hover:text-white' ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
                        <span class="text-sm font-semibold">Purchase Order (PO)</span>
                    </a>
                </li>
                <li>
                    <a href="transaksi_so.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group <?= basename($_SERVER['PHP_SELF']) == 'transaksi_so.php' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/20' : 'text-slate-400 hover:bg-white/5 hover:text-white' ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                        <span class="text-sm font-semibold">Sales Order (SO)</span>
                    </a>
                </li>
                <?php endif; ?>
                <li>
                    <a href="riwayat_transaksi.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group <?= basename($_SERVER['PHP_SELF']) == 'riwayat_transaksi.php' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/20' : 'text-slate-400 hover:bg-white/5 hover:text-white' ?>">
        ...
        <!-- Group 3: GUDANG & LOGISTIK -->
        <div>
            <p class="px-4 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] mb-4">Gudang & Logistik</p>
            <ul class="space-y-1">
                <li>
                    <a href="informasi_stok.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group <?= basename($_SERVER['PHP_SELF']) == 'informasi_stok.php' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/20' : 'text-slate-400 hover:bg-white/5 hover:text-white' ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                        <span class="text-sm font-semibold">Informasi Stok</span>
                    </a>
                </li>
                <?php if (check_access(['Admin', 'Staff Gudang', 'Supervisor'])): ?>
                <li>
                    <a href="transfer_gudang.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group <?= basename($_SERVER['PHP_SELF']) == 'transfer_gudang.php' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/20' : 'text-slate-400 hover:bg-white/5 hover:text-white' ?>">
                        ...
                        <span class="text-sm font-semibold">Transfer Gudang</span>
                    </a>
                </li>
                <?php endif; ?>
                ...
                <li>
                    <a href="inbound.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group <?= basename($_SERVER['PHP_SELF']) == 'inbound.php' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/20' : 'text-slate-400 hover:bg-white/5 hover:text-white' ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path></svg>
                        <span class="text-sm font-semibold">Inbound (Terima)</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="inventory.php" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group <?= basename($_SERVER['PHP_SELF']) == 'inventory.php' ? 'bg-amber-500 text-white shadow-lg shadow-amber-500/20' : 'text-slate-400 hover:bg-white/5 hover:text-white' ?>">
                        ...
                        <span class="text-sm font-semibold">Kartu Stok & Opname</span>
                    </a>
                </li>
                <?php if (check_access(['Admin', 'Supervisor'])): ?>
                <li>
